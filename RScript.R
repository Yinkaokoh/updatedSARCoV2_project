...
S_fig1 <- ggplot(next_strain_clade_continent, aes(y = Nextstrain_clade, x = Number)) +
...
## Supplementary Figure 2 Page 40: Top 1% Lineage diversity across continent
...
## Supplementary Figure 2 ends

## Supplementary Figure 3 page 41: Absolute Number of COVID-19 Cases across Continent
...
##Supplementary Figure 3 ends

## Supplementary Figure 4 page 42: Top 10% Lineage diversity in Africa
...
S_fig4a <- ggplot(afr_lineage_top_10, aes(y = reorder(pangolin_lineage, N), x = N)) +
  geom_bar(stat = "identity", fill = "steelblue") +
...
write.csv(africa_pangolin_lineage, file = "plots/pango_lineages_africa.csv")
